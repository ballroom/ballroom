...
**If you want to build or contribute to a ballroom project, read this document.**
...
* Click button *Browse*, select a repository directory. For example `~/projects/ballroom`.
...
* Click menu *File*, menu item *New project*.
    ...
    * Textfield *name*: `ballroom`

    * Textfield *Project files location*: `~/projects/ballroom`
...
* Click menu *File*, menu item *New module*
    ...
    * Textfield *Root directory*: `~/projects/ballroom`
